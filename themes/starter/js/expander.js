...
var Expander = (function () {
    ...
    function initEvents() {
        ...
        // next button
        $items.on('click','.js-next',function(){
            var $item = $('.c-preview--expanded');
            var $next = $item.next('.c-preview');
            showPreview($next);
            validateNavButtons();
        });

        // prev button
        $items.on('click', '.js-prev',function(){
            var $item = $('.c-preview--expanded');
            var $prev = $item.prev('.c-preview');
            showPreview($prev);
            validateNavButtons();
        });
    ...
    function validateNavButtons(){
        ...
        current === 0 || current === -1 ? $prev.hide() : $prev.show();
        current === $items.length - 1 || current === -1 ? $next.hide() : $next.show();
    }
    ...
    Preview.prototype = {
        create: function () {
            ...
            this.$prevBtn = $('<div class="c-expander__prev js-prev"></div>');
            this.$nextBtn = $('<div class="c-expander__next js-next"></div>');
            this.$previewEl = $('<div class="c-expander"></div>').append(this.$prevBtn, this.$previewInner, this.$nextBtn);

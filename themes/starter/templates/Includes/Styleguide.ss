<main class="main">
    ...
    <div class="container">
        ...
        <p>
            <button type="button" class="btn--default btn--lg">Default Button</button>
            <button type="button" class="btn--primary btn--lg">Blue Button</button>
            <button type="button" class="btn--secondary btn--lg">Red Button</button>
        </p>
        <p>
            <button type="button" class="btn--default">Default Button</button>
            <button type="button" class="btn--primary">Blue Button</button>
            <button type="button" class="btn--secondary">Red Button</button>
        </p>
